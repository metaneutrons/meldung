...
const ENV_OVERRIDES: {
  ...
  { env: 'OTOBO_ENABLED', path: ['delivery', 'otobo', 'enabled'], transform: (v) => v === 'true' },
  { env: 'OTOBO_BASE_URL', path: ['delivery', 'otobo', 'config', 'baseUrl'] },
  { env: 'OTOBO_USERNAME', path: ['delivery', 'otobo', 'config', 'username'] },
  { env: 'OTOBO_PASSWORD', path: ['delivery', 'otobo', 'config', 'password'] },
  {
    env: 'WEBHOOK_ENABLED',
    path: ['delivery', 'webhook', 'enabled'],
    transform: (v) => v === 'true',
  },
  { env: 'WEBHOOK_URL', path: ['delivery', 'webhook', 'config', 'url'] },
  { env: 'WEBHOOK_SECRET', path: ['delivery', 'webhook', 'config', 'secret'] },
  {
    env: 'ZAMMAD_ENABLED',
    path: ['delivery', 'zammad', 'enabled'],
    transform: (v) => v === 'true',
  },
  { env: 'ZAMMAD_BASE_URL', path: ['delivery', 'zammad', 'config', 'baseUrl'] },
  { env: 'ZAMMAD_TOKEN', path: ['delivery', 'zammad', 'config', 'token'] },
